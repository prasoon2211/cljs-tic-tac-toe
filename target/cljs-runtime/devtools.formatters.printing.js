...
var len__4736__auto___30617 = arguments.length;
var i__4737__auto___30618 = (0);
while(true){
if((i__4737__auto___30618 < len__4736__auto___30617)){
args__4742__auto__.push((arguments[i__4737__auto___30618]));

var G__30619 = (i__4737__auto___30618 + (1));
i__4737__auto___30618 = G__30619;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30572){
...
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30573,G__30574,seq30572__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30593_SHARP_){
return (!((cljs.core.meta(p1__30593_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30596__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30602){var _e__29872__auto__ = e30602;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e30604){var _e__29872__auto__ = e30604;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__30606 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30607 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30607);

try{var map__30608 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30608__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30606);
}});
...
var temp__5733__auto___30630 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___30630)){
var managed_print_level_30631 = temp__5733__auto___30630;
var _STAR_print_level_STAR__orig_val__30613_30635 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30614_30636 = managed_print_level_30631;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30614_30636);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__30612_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__30612_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30613_30635);
}} else {
job_fn();
}

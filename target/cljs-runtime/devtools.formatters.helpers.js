...
var G__30565 = devtools.prefs.pref(v);
v = G__30565;
continue;
} else {
return v;
...
}catch (e30500){var _e__29872__auto__ = e30500;
return false;
}})();
...
}catch (e30508){var _e__29872__auto__ = e30508;
return false;
}})();
...
}catch (e30514){var _e__29872__auto__ = e30514;
return false;
}}
}
});
...
var vec__30538 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30538,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30538,(1),null);
...
return cljs.core.some((function (p1__30548_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__30548_SHARP_);
}),template);
});

...
var G__31018 = o;
goog.object.set(G__31018,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__31024 = o;
goog.object.set(G__31024,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__31049__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__31053__i < G__31053__a.length) {G__31053__a[G__31053__i] = arguments[G__31053__i + 0]; ++G__31053__i;}
  args = new cljs.core.IndexedSeq(G__31053__a,0,null);
} 
return G__31049__delegate.call(this,args);};
G__31049.cljs$lang$maxFixedArity = 0;
G__31049.cljs$lang$applyTo = (function (arglist__31054){
var args = cljs.core.seq(arglist__31054);
return G__31049__delegate(args);
});
...
var G__31025 = props;
var G__31025__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31025,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__31025);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31025__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__31026 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31026,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__31026;
}
})(),id_class);
...
var G__31027 = (cljs.core.count(argv) - first_child);
switch (G__31027) {
case (0):
...
var vec__31028 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31028,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31028,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31028,(2),null);
...
var temp__5739__auto___31078 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___31078 == null)){
} else {
var key_31079 = temp__5739__auto___31078;
(jsprops.key = key_31079);
}
...
var temp__5739__auto___31080 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___31080 == null)){
} else {
var key_31081 = temp__5739__auto___31080;
(jsprops.key = key_31081);
}
...
var temp__5739__auto___31089 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___31089 == null)){
} else {
var key_31090 = temp__5739__auto___31089;
(jsprops.key = key_31090);
}
...
var temp__5739__auto___31100 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___31100 == null)){
} else {
var key_31101 = temp__5739__auto___31100;
(jsprops.key = key_31101);
}
...
var temp__5739__auto___31103 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___31103 == null)){
} else {
var key_31105 = temp__5739__auto___31103;
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31031_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__31031_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__31032 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31032,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31032,(1),null);
...
break;
default:
var G__31122 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template31038 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template31038 = (function (opts,id,fn_to_element,meta31039){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template31038.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_31040,meta31039__$1){
var self__ = this;
var _31040__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template31038(self__.opts,self__.id,self__.fn_to_element,meta31039__$1));
}));

(reagent.impl.template.t_reagent$impl$template31038.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_31040){
var self__ = this;
var _31040__$1 = this;
return self__.meta31039;
}));

(reagent.impl.template.t_reagent$impl$template31038.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template31038.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template31038.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template31038.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template31038.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"meta31039","meta31039",-402019299,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template31038.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template31038.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template31038");

(reagent.impl.template.t_reagent$impl$template31038.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template31038");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template31038.
 */
reagent.impl.template.__GT_t_reagent$impl$template31038 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template31038(opts__$1,id__$1,fn_to_element__$1,meta31039){
return (new reagent.impl.template.t_reagent$impl$template31038(opts__$1,id__$1,fn_to_element__$1,meta31039));
});

}

return (new reagent.impl.template.t_reagent$impl$template31038(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});

...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26477 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26477(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26484 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26484(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26485 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26485(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26486 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26486(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26487 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26487(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26490 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26490(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26491 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26491(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26492 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26492(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26494 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26494(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26495 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26495(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26496 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26496(b);
}
});
